...
9. `docs/explanation/jwt_authentication.md` - Detailed documentation
10. `docs/explanation/jwt_authentication_summary.md` - This summary
...
- Detailed JWT Documentation: `docs/explanation/jwt_authentication.md`
