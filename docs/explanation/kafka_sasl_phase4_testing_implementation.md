...
- `docs/explanation/kafka_sasl_scram_authentication_plan.md` - Original implementation plan
- `docs/explanation/kafka_sasl_phase3_configuration_loading.md` - Phase 3 implementation
